...
function isNullOrUndefined(node) {
    return (
        ...
        module.exports.isUndefinedIdentifier(node) ||
...
module.exports = {
    ...
    /**
     * Determines whether the given node is a `undefined` literal.
     * @param {ASTNode} node The node to check
     * @returns {boolean} `true` if the node is a `undefined` literal
     */
